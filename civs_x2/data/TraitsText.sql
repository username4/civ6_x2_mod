...
UPDATE LocalizedText
SET Text = 'American unique Modern era air unit that replaces the Fighter.  Gains +10 attack against fighter aircraft, has +4 flight range, and gains +500% experience.'
WHERE Language = 'en_US'
AND Tag = 'LOC_UNIT_AMERICAN_P51_DESCRIPTION';

UPDATE LocalizedText
SET Text = 'A building unique to America. +200% [ICON_Tourism] Tourism pressure from this city towards other civilizations in the Modern era.'
WHERE Language = 'en_US'
AND Tag = 'LOC_BUILDING_FILM_STUDIO_DESCRIPTION';

UPDATE LocalizedText
SET Text = 'Units receive a +10 [ICON_Strength] Combat Strength on their home continent. +2 Appeal to all tiles in a city with a National Park. Gain the Rough Rider unique unit when they research the Rifling technology.'
WHERE Language = 'en_US'
AND Tag = 'LOC_BUILDING_FILM_STUDIO_DESCRIPTION';
